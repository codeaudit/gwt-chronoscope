...
/**
 * Helper class used to parse microformat annotations in the DOM and turn those into charts.
 *
...
public class Microformats {
    ...
    public static void initializeMicroformats(Chronoscope chronoscope) {
        ...
        final Element[] links = getElementsByClassName(null, "a", CMF_PREFIX+"-marker");
...
//                DOM.setStyleAttribute(div, "height", "300px");
                ...
                ChartPanel cp = Chronoscope.createTimeseriesChart(cid, ds, candidateWidth, candidateHeight,
                                                                  new MicroformatViewReadyCallback(links, cid, id, ds,
                                                                                                   elt));
                created[i] = cp;
            }
    ...
    private static Element[] getElementsByClassName(Element elt, String tag, String className) {
    ...
    public static native JavaScriptObject importMicroformatTable0(String id, Element table) /*-{
    ...
    private static native JavaScriptObject getElementsByClassName0(JavaScriptObject elt, String tag, String className) /*-{
           var result=[];
    ...
    private static class MicroformatViewReadyCallback implements ViewReadyCallback {
        ...
        public MicroformatViewReadyCallback(Element[] links, String id, String chartId, XYDataset[] ds, Element elt) {
            this.links = links;
            this.id = id;
        ...
        public void onViewReady(View view) {
            ...
            for (int j = 0; j < links
                ...
                if (href != null && href.startsWith("#" + chartId)) {
                    ...
                    final Element[] infoWindow = getElementsByClassName(links[j], "span", CMF_PREFIX+"-infowindow");
                    final Marker m = new Marker(
                            (double) Date.parse(date), ( ds[0].getRangeTop() - ds[0].getRangeBottom() ) / 2, label, 0);
