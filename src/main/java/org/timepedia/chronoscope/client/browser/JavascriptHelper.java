...
public class JavascriptHelper {
    public static native JavaScriptObject jsPropGet(JavaScriptObject json, String propName) /*-{
        return json[propName];
    }-*/;

    public static native String jsPropGetString(JavaScriptObject json, String propName) /*-{
        var s=json[propName];
        if(!s) return null;
        return ""+s;
    }-*/;
    ...
    public static native JavaScriptObject jsArrGet(JavaScriptObject datasets, int i) /*-{
        return datasets[i];
    }-*/;
