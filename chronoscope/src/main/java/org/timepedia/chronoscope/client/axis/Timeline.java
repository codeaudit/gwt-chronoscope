...
public interface Timeline {
     ...
     */
    double toTimelineValue(double millisecond);
     ...
     * @return A timeline value
     */
    double toTimelineValue(Date date);
     ...
     */
    double toMillisecond(double timelineValue);
     ...
     */
    boolean containsDomainValue(double millisecond);
     ...
     *         <code>false</code> otherwise
     */
    boolean containsDomainRange(double fromMillisecond, double toMillisecond);
