...
public class BrowserLinearGradient implements LinearGradient {
    ...
    BrowserLinearGradient(BrowserLayer layer, double x, double y, double width, double height) {
        nativeGradient = createNativeGradient(layer.getContext(), x, y, width, height);
    ...
    private native JavaScriptObject createNativeGradient(JavaScriptObject ctx, double x, double y, double width,
                                                         double height) /*-{
