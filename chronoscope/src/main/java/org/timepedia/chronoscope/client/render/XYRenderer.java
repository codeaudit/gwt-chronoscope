 ...
 */
public abstract class XYRenderer<T extends XYDataset> implements Exportable {
   ...
   * being rendered
   */
  public abstract void drawCurvePart(XYPlot<T> plot, Layer layer, double dataX,
   ...
   */
  public abstract void drawPoint(XYPlot<T> plot, Layer layer, double domainX,
