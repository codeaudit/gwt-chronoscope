...
/**
 * Responsible for iterating over datasets in a defined drawing order, and then deciding on how to map the visible
 * portions of the domain onto the associated xyRenderers
 *
...
public abstract class XYPlotRenderer {
     ...
     * @param plot
     */
    public abstract void drawDataset(Layer can, XYDataset dataSet, XYRenderer XYRenderer, int seriesNum, XYPlot plot);
    ...
    public void drawDatasets() {
        ...
        for (int i = 0; i < renderOrder.length; i++) {
            ...
            drawDataset(plotLayer, plot.getDataset(index), plot.getRenderer(index), index, plot);
        }
    }
