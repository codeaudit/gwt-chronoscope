...
/**
 * An implementation of ChronoscopeMenu using GWT PopupPanel and MenuBar/Menuitem
 */
...
//                    Window.alert("Clicked " + label);
    ...
    static class ChronoscopeMenuBar extends MenuBar {
         ...
         * It must not be overridden, except by {@link com.google.gwt.user.client.ui.Panel}. To receive
