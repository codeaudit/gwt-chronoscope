...
/**
 * Implements a GssContext by injecting hidden DOM elements for each GssElement,pseudoElement pair that is queried.
 */
public class CssGssContext extends GssContext {
    ...
    public GssProperties getProperties(GssElement elem, String pseudoElt) {
        ...
        CssGssProperties gss = (CssGssProperties) GWT.create(CssGssProperties.class);
    ...
    private native void setAttribute(Element styleElement, String name, String value) /*-{
